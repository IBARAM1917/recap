...
getDetailsButton.addEventListener("click",async()=>{
    ...
    //since we are going to fetch api we are changing to async functtion and will be using await keyword to handling
...
//getting the username and passing to another api to get repostroryies
